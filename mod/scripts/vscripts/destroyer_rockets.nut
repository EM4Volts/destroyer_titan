global function Destroyer_MpTitanWeaponShoulderRockets_Init
global function Destroyer_OnWeaponOwnerChanged_titanweapon_shoulder_rockets
global function Destroyer_OnWeaponPrimaryAttack_titanweapon_shoulder_rockets
global function Destroyer_OnWeaponAttemptOffhandSwitch_titanweapon_shoulder_rockets
global function Destroyer_OnWeaponChargeBegin_titanweapon_shoulder_rockets
#if SERVER
global function Destroyer_OnWeaponNpcPrimaryAttack_titanweapon_shoulder_rockets
#endif
...
const float SHOULDERROCKETS_MISSILE_SPEED 		= 90.0
const SHOULDERROCKETS_APPLY_RANDOM_SPREAD 		= true
const SHOULDERROCKETS_LAUNCH_OUT_TIME 			= 0.11
const SHOULDERROCKETS_LAUNCH_IN_LERP_TIME 		= 0.0
const SHOULDERROCKETS_LAUNCH_IN_TIME 			= 1.0
...
void function Destroyer_MpTitanWeaponShoulderRockets_Init()
{
	#if MP
...
bool function Destroyer_OnWeaponAttemptOffhandSwitch_titanweapon_shoulder_rockets( entity weapon )
{
	return weapon.GetWeaponChargeFraction() <= 0.8
}

void function Destroyer_OnWeaponOwnerChanged_titanweapon_shoulder_rockets( entity weapon, WeaponOwnerChangedParams changeParams )
{
	Init_titanweapon_shoulder_rockets( weapon )
}

bool function Destroyer_OnWeaponChargeBegin_titanweapon_shoulder_rockets( entity weapon )
{
...
var function Destroyer_OnWeaponPrimaryAttack_titanweapon_shoulder_rockets( entity weapon, WeaponPrimaryAttackParams attackParams )
{
...
#if SERVER
var function Destroyer_OnWeaponNpcPrimaryAttack_titanweapon_shoulder_rockets( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	return Destroyer_OnWeaponPrimaryAttack_titanweapon_shoulder_rockets( weapon, attackParams )
}
#endif